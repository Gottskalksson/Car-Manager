...
<div class="row h-100">
    <div class="card card-block w-50 mx-auto">
        <form:form cssClass="form-horizontal" modelAttribute="car" method="post" action="/dashboard/cars/add">
        ...
        <a href="${pageContext.request.contextPath}/dashboard/cars/list">Lista samochodów</a>
    </div>
</div>
